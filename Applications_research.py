...
# 
# 1.[A data set]('https://www.kaggle.com/datasets/lava18/google-play-store-apps') containing data about approximately ten thousand Android apps from Google Play. You can download the data set directly from this [link]('https://dq-content.s3.amazonaws.com/350/googleplaystore.csv').
# 
# 2.[A data set]('https://www.kaggle.com/datasets/ramamet4/app-store-apple-data-set-10k-apps') containing data about approximately seven thousand iOS apps from the App Store. You can download the data set directly from this [link]('https://dq-content.s3.amazonaws.com/350/AppleStore.csv').
# 
